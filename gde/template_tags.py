    ...
    def generate_js_asset(
        ...
        if "imports" in manifest_entry:
            for vendor_path in manifest_entry.get("imports"):
                tags.append(
                    self.generate_js_asset(vendor_path, scripts_attrs=scripts_attrs)
                )
...
def js_dev_asset(asset_path: str, scripts_attrs: Optional[Dict[str, str]] = None) -> markupsafe.Markup:
